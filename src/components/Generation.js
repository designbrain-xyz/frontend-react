    ...
    <div className={styles.content}>
      ...
      >
        ...
        <SwiperSlide className={styles.slide}>
          ...
          <SwiperSlide className={styles.slide}>
            <img src="https://pro-dachnikov.com/uploads/posts/2023-01/1672813739_pro-dachnikov-com-p-krutoi-remont-v-kvartire-foto-4.jpg" />
          </SwiperSlide>
          <SwiperSlide className={styles.slide}>
            <img src="https://i.pinimg.com/originals/ce/93/4f/ce934f462cb1b0987e108ad3a747e4c2.jpg" />
          </SwiperSlide>
          <SwiperSlide className={styles.slide}>
            <img src="https://almode.ru/uploads/posts/2021-07/1625493259_21-almode_ru-p-dom-s-vidom-na-more-22.jpg" />
          </SwiperSlide>
          <SwiperSlide className={styles.slide}>
            <img src="https://centro-pol.ru/wp-content/uploads/2018/06/5-32.jpg" />
          </SwiperSlide>
          <SwiperSlide className={styles.slide}>
            <img src="https://stroy-podskazka.ru/images/article/orig/2017/12/haj-tek-sovremenyj-stil-novyh-tehnologij-v-interere-71.jpg" />
          </SwiperSlide>
      </Swiper>
